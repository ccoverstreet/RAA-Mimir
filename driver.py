...
def Gen_Test_1():
    ...
    x.set_stage_impulses([3, 2])
    x.set_stage_burn_times([1, 2])
    x.set_stage_delay_times([0, 999])
    x.set_stage_total_masses([0.100, 0.05])
    x.set_stage_dry_masses([0.05, 0.025])
